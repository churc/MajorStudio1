...
barTotalsSort = barTotals;
	...
	//////   ADDING		  
//		  p.translate(15, 0); // jump to the top right corner of the bar
		  p.translate(0, 0);
	/////END
...
//			h = 1440,
//          margin = 50,
//          width = p.w - 2 * margin, // chart area width and height
//          height = p.h - 2 * margin;
	
	/////END   - note greyed out old width
...
////Attempts to get the axis lined up	
//    p.translate(width*1.66,4790);  ///original on github with 
	//	var width = 1440, 
//        height = p.windowHeight;
//p.translate(width*2-margin*6, height*7-margin*5.5); ///in github code with windowHeight
//	p.translate(h*2-margin*8.5, w-h/1.88);
//	p.translate(height*3, width*3.5);
