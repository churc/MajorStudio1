...
//           p.rect(160 + (i * 10), $(window).height()/1.91, 10, barTotals[i]['m']/2);
      ////1440 screen
          p.rect(160 + (i * 10), $(window).height()/2.11, 10, barTotals[i]['m']/2);
      ////1980 screen
...
//           bars.push({x:160 + (i * 10), y:$(window).height()/1.91, width: 10, height: barTotals[i]['f']/2, name:barTotals[i].name, maleHeight: barTotals[i]['m']/2});
      ////1440 screen
          var bar = p.rect(160 + (i * 10), $(window).height()/2.11, 10, (-1) * barTotals[i]['f']/2);
          bars.push({x:160 + (i * 10), y:$(window).height()/2.11, width: 10, height: barTotals[i]['f']/2, name:barTotals[i].name, maleHeight: barTotals[i]['m']/2});
