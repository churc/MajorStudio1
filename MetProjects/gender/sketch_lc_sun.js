...
function setup(){
   ...
   push();
    ...
    noFill();
    beginShape(); 
    vertex(830, 20);   // total m/2 = 10817/2 = 5408.5
    vertex(830, 760);   //  740
    vertex(940, 760);   //  110
    vertex(940,  20);   //740
    vertex(1280,  20);   //340
    ...
    vertex(1110, 40);    //140
    vertex(1110, 840);   //800
    vertex(221.5, 840);  //888.5      ///5480.5
    endShape();  
    pop();

    push();
    stroke(205,116,247,90);
    // stroke(153,50,204,80); //total f/2 = 2021/2 = 1010.5
    strokeWeight(5);
    noFill();
    beginShape();
    vertex(836, 20);   //  
    ...
    push();
    stroke(100,100);  //total u unknown 1314/2 = 657
    strokeWeight(5);
    noFill();
    beginShape();
    vertex(848, 20);   //  
    ...
    push();
    stroke(204,186,25,120);  //total a to find out 41/2 = 20.5
    strokeWeight(5);
    noFill();
    beginShape();
    vertex(854, 20);   //  
    vertex(854,  40.5);   // 20.5
    endShape();
...
for(var i=1850; i<=2017; i+=10){
  ...
  text("Year", 1341-margin-140,747-margin+50);
...
////4. Add legend
  ...
  textSize(12);
  fill (77,77,77);
  text("artwork by male artist", 120,117);
  text("artwork by female artist", 120,147);
  text("artwork by two or more artists of both genders",120,177);
  text("artwork by unknown artist",120,207);
  text("artwork by named artist, gender unknown",120,237)
};
