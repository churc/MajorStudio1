...
var myp5 = new p5(s, 'canvas-wrappedBars');
...
var genFill = singleData[b];
    ...
    p.push();  //save 
      ...
      p.rect(100, -p.windowWidth/2, singleData[b]/2, barWidth/2);

      p.fill(0,0,0);
      // p.text(singleData[b], 100, barWidth/2 + -p.windowWidth/1.53); // write data label

            p.text(singleData[b], 102, barWidth/2 + -p.windowWidth/2.05); // write data label
...
//label long bars
    p.push();
        ...
        p.fill(77,77,77);
        p.textSize(29);
        p.text("The Met Modern & Contemporary Art Collection", 100, barWidth/20 + -p.windowWidth/2.74);
        p.textSize(18.5);
        p.text("Scale: 1 pixel = 2 artworks", 100, barWidth/20 + -p.windowWidth/2.985);
    p.pop();
...
p.push();   
  ...
  // p.line(p.windowWidth/2.46,10829/2+100,p.windowWidth/2.065,10829/2+100);
   ...
   p.line(p.windowWidth/3.7, 48/2+100,p.windowWidth/3.11, 48/2+100);
  p.line(p.windowWidth/3.7,128/2+100,p.windowWidth/3.11, 128/2+100);
  p.line(p.windowWidth/3.7,1318/2+100,p.windowWidth/3.11, 1318/2+100);
  p.line(p.windowWidth/3.7,2027/2+100,p.windowWidth/3.11, 2027/2+100);
  p.line(p.windowWidth/3.7,10829/2+100,p.windowWidth/3.11, 10829/2+100);
 ...
 //text
  ...
  p.text("unidentified: 48", p.windowWidth/3.7, 48/2+95);

  p.text("couple: 128", p.windowWidth/3.7, 128/2+95);
  p.text("unknown: 1318", p.windowWidth/3.7, 1318/2+95);
  p.text("female: 2027", p.windowWidth/3.7, 2027/2+95);
  p.text("male: 10829", p.windowWidth/3.7, 10829/2+95);
p.pop();
...
p.drawmeasureline = function(){
  ...
  p.translate(1200,100);
  p.rotate(p.radians(90));
  p.textStyle(p.NORMAL);
  // p.text("Number of Artworks", 69, -55);
  p.text("Number of Artworks", 69, -68);
...
var myp5 = new p5(t, 'canvas-singleBars');
